...
# CONFIG
# ==============================================
DATA_PATH = "testing.csv"     # your file (without ticker)
MODEL_PATH = "model_xgboost_gpu_chunked.json"
OUT_CSV = "predictions_today.csv"
DEFAULT_TICKER = "ICICIBANK"          # auto-assign ticker name if missing
...
# Lag features (only if data is long enough)
LAGS = [1, 2, 3, 5]
for lag in LAGS:
...
# Handle very short data (remove missing features)
...
# 6️⃣ SAVE OUTPUT
# ==============================================
keep = ['date', 'ticker', 'close', 'pred_prob', 'signal', 'expected_next_move']
df_out = df[keep].copy()
